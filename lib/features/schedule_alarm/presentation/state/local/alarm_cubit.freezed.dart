...
class _Loading implements AlarmState {
  const _Loading();
...
class _Success implements AlarmState {
  const _Success();
...
class _Error implements AlarmState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $AlarmStateCopyWith<$Res> {
